...
_MEASURES = [
    {"measure_index": 1, "notes": [
        ...
        {"pitch": "D4", "duration": "quarter", "position": 1, "lyric": "짝"},
        {"pitch": "A4", "duration": "quarter", "position": 2, "lyric": "반"},
        {"pitch": "A4", "duration": "quarter", "position": 3, "lyric": "짝"},
    ]},
    {"measure_index": 2, "notes": [
        {"pitch": "B4", "duration": "quarter", "position": 0, "lyric": "작"},
        {"pitch": "B4", "duration": "quarter", "position": 1, "lyric": "은"},
        {"pitch": "A4", "duration": "half", "position": 2, "lyric": "별"},
    ]},
    {"measure_index": 3, "notes": [
        {"pitch": "G4", "duration": "quarter", "position": 0, "lyric": "아"},
        {"pitch": "G4", "duration": "quarter", "position": 1, "lyric": "름"},
        {"pitch": "F#4", "duration": "quarter", "position": 2, "lyric": "답"},
        {"pitch": "F#4", "duration": "quarter", "position": 3, "lyric": "게"},
    ]},
    {"measure_index": 4, "notes": [
        {"pitch": "E4", "duration": "quarter", "position": 0, "lyric": "비"},
        {"pitch": "E4", "duration": "quarter", "position": 1, "lyric": "치"},
        {"pitch": "D4", "duration": "half", "position": 2, "lyric": "네"},
    ]},
    {"measure_index": 5, "notes": [
        {"pitch": "A4", "duration": "quarter", "position": 0, "lyric": "동"},
        {"pitch": "A4", "duration": "quarter", "position": 1, "lyric": "쪽"},
        {"pitch": "G4", "duration": "quarter", "position": 2, "lyric": "하"},
        {"pitch": "G4", "duration": "quarter", "position": 3, "lyric": "늘"},
    ]},
    {"measure_index": 6, "notes": [
        {"pitch": "F#4", "duration": "quarter", "position": 0, "lyric": "에"},
        {"pitch": "F#4", "duration": "quarter", "position": 1, "lyric": "서"},
        {"pitch": "E4", "duration": "half", "position": 2, "lyric": "도"},
    ]},
    {"measure_index": 7, "notes": [
        {"pitch": "A4", "duration": "quarter", "position": 0, "lyric": "서"},
        {"pitch": "A4", "duration": "quarter", "position": 1, "lyric": "쪽"},
        {"pitch": "G4", "duration": "quarter", "position": 2, "lyric": "하"},
        {"pitch": "G4", "duration": "quarter", "position": 3, "lyric": "늘"},
    ]},
